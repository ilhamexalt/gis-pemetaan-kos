	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url() ?>">Login as Admin</a>

			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-button navbar-nav navbar-right">
					<li>
						<a href="<?php echo base_url('user/logout') ?>" class="hvr-rotate" title="Lgoin">
			...
			<div class="col-md-2 user-sidebar">
				<div id="sidebar-sticker">
					<div class="list-group" style="margin-top: 20px;">
						...
						<a href="<?php echo base_url('admin/addkost') ?>" class="list-group-item <?php echo active_link_method('addkost', 'admin') ?>">
							<i class="fa fa-plus"></i> Tambah Data
						</a>
						<a href="<?php echo base_url('admin/datakost') ?>" class="list-group-item <?php echo active_link_method('kost', 'admin') ?>">
							<i class="fa fa-bed"></i> Data Kost
						</a>
						<!-- <a href="#" class="list-group-item ?php echo active_link_method('account', 'admin') ?>">
							<i class="fa fa-wrench"></i> Pengaturan Akun
						</a> -->
						<!-- <a href="?php echo base_url('admin/Leaflet') ?>" class="list-group-item ?php echo active_link_method('account', 'admin') ?>">
							<i class="fa fa-wrench"></i> Coba Leaflet
						</a> -->
					</div>
				</div>
			</div>
