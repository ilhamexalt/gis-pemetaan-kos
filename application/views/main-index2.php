	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col" style="position: absolute; top: 70px; right: 15px;">
				...
				<br> -->
				<form action="<?php echo site_url('Admin/filterHarga') ?>" method="post">
					<div class="bg-primary text-center" style="padding: 2px; border-radius: 10px; margin-bottom: 10px">
						<h5>Filter Tempat Kost</h5>
					</div>
					<div>
						<input type="text" name="from_harga" id="inputFromHarga">
					</div>
					<p>to </p>
					<div>
						<input type="text" name="to_harga" id="inputToHarga">
					</div>
						<!-- <select class="form-control" id="filter">
						<option>Berdasarkan Harga</option>
						<option name="hargaLow">Rp400.000 s/d Rp500.000</option>
						<option name="hargaMid">Rp600.000 s/d Rp700.000</option>
						<option name="hargaUp">Rp800.000 s/d Rp1.200.000</option>
					</select> -->
