...
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    ...
    <!-- readonly and hidden -->
    <input type="text" name="id_user" class="form-control" value="<?= $this->session->userdata('id_user'); ?>" readonly hidden>
    <!-- end -->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="pemilik" id="pemilik" class="form-control" value="<?= $this->session->userdata('fullname'); ?>" readonly>
            <p class="help-block"><?php echo form_error('pemilik', '<small class="text-red">', '</small>'); ?></p>
        </div>
    </div>
    <div class="form-group">
